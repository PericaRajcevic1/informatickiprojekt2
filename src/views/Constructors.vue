<template>
  ...
  <v-container>
    ...
    <h4 style="font-size: 2rem" class="text-center"> Poredak konstruktora {{ season }}  </h4>
      ...
      >
        ...
        <v-card-title>
          ...
          <v-chip-group>
            ...
            <v-chip>
              <v-icon>mdi-counter</v-icon> &nbsp; {{ constructor.points }} bodova
            </v-chip>
            <v-chip>
              <v-icon>mdi-trophy</v-icon> &nbsp; Pobjede: {{ constructor.wins }} 
            </v-chip>
          </v-chip-group>
        </v-card-title>
